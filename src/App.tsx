	...
	return (
		<>
			...
			<Project
				date="2026"
				title="ROMGrid"
				description="Personal project to create a icon generator based on console and community styles. Still in development. Beta release will come out soon."
				imgName="romgrid-logo.svg"
				technologies={[<SiNextdotjs />, <RiTailwindCssFill />, <SiShadcnui />]}
			/>
			<Project
				date="2025"
				title="GymPrep"
