...
export default function Icon({
  ...
  const generateIcon: () => React.ReactElement = () => {
    if (iconType == IconType.Linkedin) {
      ...
      return (
        <svg {...commonProps} viewBox="0 0 20 20">
      ...
      return (
        <svg viewBox="0 0 128 128" {...commonProps}>
          <path
      ...
      return (
        ...
        >
          <g transform="scale(2.81)">
            <path
              d="M2.57 30h84.86C81.254 12.534 64.611 0.015 45.033 0H44.965C25.388 0.015 8.745 12.534 2.57 30z"
              fill="black"
            />
            <path
              d="M87.429 60H2.57C8.749 77.476 25.408 90 45 90s36.251-12.524 42.429-30z"
              fill="#ffce00"
            />
            <path
              d="M87.429 60c1.659-4.693 2.571-9.739 2.571-15s-0.912-10.307-2.571-15H2.57C0.911 34.693 0 39.739 0 45s0.912 10.307 2.571 15h84.858z"
              fill="#dd0000"
            />
          </g>
        </svg>
  ...
  if (link) {
    ...
    return <div onClick={onClick}>{generateIcon()}</div>;
  }
}
